...
public class AdminDaoImpl implements AdminDao{
    ...
    private static final String PASS_ACTIVITY = "UPDATE " + InformationDaoImpl.INFO_REQUEST_TABLE + " SET status = 'pass' WHERE info_id = ?";

    private static final String DENY_ACTIVITY = "UPDATE " + InformationDaoImpl.INFO_REQUEST_TABLE + " SET status = 'pass' WHERE info_id = ? ";
